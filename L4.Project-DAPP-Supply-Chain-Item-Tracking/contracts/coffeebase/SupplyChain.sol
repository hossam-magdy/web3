    ...
    ConsumerRole
{
    ...
    modifier checkValue(uint256 _upc) {
        ...
        // https://ethereum.stackexchange.com/a/19343
        // items[_upc].consumerID.call{value: amountToReturn}("");
    ...
    function harvestItem(
        ...
        Item memory item = Item({
            ...
            upc: upc, // Universal Product Code (UPC), generated by the Farmer, goes on the package, can be verified by the Consumer
            ...
            productPrice: 0, // uint256 productPrice, // Product Price
            itemState: State.Harvested, // Product State as represented in the enum above
            distributorID: address(0), // address distributorID, // Metamask-Ethereum address of the Distributor
            retailerID: address(0), // address retailerID, // Metamask-Ethereum address of the Retailer
            consumerID: address(0) // address consumerID, // Metamask-Ethereum address of the Consumer
        });
        ...
        checkValue(_upc)
    {
        ...
        (bool success, ) = items[_upc].originFarmerID.call{value: price}("");
